...
blueprint = Blueprint('api', _name_, url_prefix='/api')
...
parser4SignIn.add_argument('Authorzation', type=str, location='headers', required=True, help='Nomor HP base64')
...
class Feedback_Route(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            return {
                'message' : 'Terimakasih sudah memberikan Feedback !'
            }, 201
        except:
            return {'message': 'Token tidak valid, silahkan masuk dulu mom'}, 401
...
class ChatBot(Resource):
    ...
    def post(self):
        ...
        response_tag = le.inverse_transform(output.numpy().flatten())[0]
